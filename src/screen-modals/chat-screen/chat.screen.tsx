...
const ChatScreen = ({navigation, route}: any) => {
  ...
  const onSendMessage = () => {
    try {
      const message = async () => {
        const responseNewMessage = await chatMessageService.sendNewMessage(
          chatId,
          text,
        );
        ...
        <KeyboardAwareScrollView
          ...
          <View
            ...
            <View
              ...
              <NbAvatar url={targetUser?.profilePhoto as string} size={30} />
              <Text>
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <Text
                  style={{fontSize: 12, color: '#BBBBBB', fontStyle: 'italic'}}>
                  Amigo
                </Text>
              </View>
            </View>
