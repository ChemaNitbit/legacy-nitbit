...
const DropdownMenu = () => {
    ...
    return (
        <View style={{ flex: 1, zIndex: 9999, position: 'relative' }}>
            <IconButton onPress={toggleMenu} icon={() => <MaterialCommunityIcons name="dots-vertical" color={'black'} size={30} />} />



            {isOpen && (
                <View style={{ position: 'absolute', top: 30, right: 0, backgroundColor: '#fff', padding: 10, zIndex: 9999 }}>
